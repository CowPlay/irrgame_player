...
//			virtual void setInputReceivingSceneManager(
...
//
//			void calculateGammaRamp(u16 *ramp, f32 gamma,
...
//			{
//					SMouseMultiClicks() :
//							DoubleClickTime(500), CountSuccessiveClicks(0), LastClickTime(
//									0), LastMouseInputEvent(EMIE_COUNT)
//					{
//					}
//
//					u32 DoubleClickTime;
