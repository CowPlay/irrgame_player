...
//			IrrlichtDevice(), VideoDriver(0), GUIEnvironment(0), SceneManager(
//					0), Timer(0), CursorControl(0), UserReceiver(
//					params.EventReceiver), Logger(0), Operator(0), FileSystem(
//					0), InputReceivingSceneManager(0), CreationParams(params), Close(
//					false)
//	{
//		Timer = new CTimer();
...
//			w += getVersion();
//			w +=
//					") does not match the version the application was compiled with (";
//			w += version;
...
//			EMOUSE_INPUT_EVENT inputEvent)
//	{
//		const s32 MAX_MOUSEMOVE = 3;
//
//		u32 clickTime = getTimer()->getRealTime();
//
//		if ((clickTime - MouseMultiClicks.LastClickTime)
//				< MouseMultiClicks.DoubleClickTime
//				&& core::abs_(MouseMultiClicks.LastClick.X - mouseX)
//						<= MAX_MOUSEMOVE
//				&& core::abs_(MouseMultiClicks.LastClick.Y - mouseY)
//						<= MAX_MOUSEMOVE
...
//	void CIrrDeviceStub::setInputReceivingSceneManager(
...
//	bool CIrrDeviceStub::activateJoysticks(
...
//	/*!
//	 */
//	void CIrrDeviceStub::calculateGammaRamp(u16 *ramp, f32 gamma,
...
//	bool CIrrDeviceStub::setGammaRamp(f32 red, f32 green, f32 blue,
...
//	bool CIrrDeviceStub::getGammaRamp(f32 &red, f32 &green, f32 &blue,
//			f32 &brightness, f32 &contrast)
//	{
//		return false;
//	}
