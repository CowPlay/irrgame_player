...
//:  MeshManipulator(0), ViewPort(0,0,0,0), ScreenSize(screenSize),
...
//
//	ViewPort = recti(position2di(0,0), dimension2di(screenSize));
//
//	// create manipulator
...
//	removeAllHardwareBuffers();
		...
		void CNullDriver::beginScene(SColor color, bool backBuffer,
...
//	updateAllHardwareBuffers();
		...
		//! Returns FPS counter.
		IFPSCounter* CNullDriver::getFPSCounter() const
		{
			return FPSCounter;
		}
