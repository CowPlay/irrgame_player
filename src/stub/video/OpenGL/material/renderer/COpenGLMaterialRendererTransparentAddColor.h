/*
 * COpenGLMaterialRendererTransparentAddColor.h
 *
 *  Created on: Oct 30, 2012
 *      Author: gregorytkach
 */

#ifndef COPENGLMATERIALRENDERERTRANSPARENTADDCOLOR_H_
#define COPENGLMATERIALRENDERERTRANSPARENTADDCOLOR_H_
...
namespace irrgame
{
	namespace video
	{
		...
		class COpenGLMaterialRendererTransparentAddColor: public COpenGLMaterialRenderer
		{
			public:

				//! Default constructor
				COpenGLMaterialRendererTransparentAddColor(
						IVideoDriver* driver);

				//! Destructor
				virtual ~COpenGLMaterialRendererTransparentAddColor();
...
#endif /* COPENGLMATERIALRENDERERTRANSPARENTADDCOLOR_H_ */
