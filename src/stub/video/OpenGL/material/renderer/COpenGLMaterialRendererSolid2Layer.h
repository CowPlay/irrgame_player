/*
 * COpenGLMaterialRendererSolid2Layer.h
 *
 *  Created on: Oct 30, 2012
 *      Author: gregorytkach
 */

#ifndef COPENGLMATERIALRENDERERSOLID2LAYER_H_
#define COPENGLMATERIALRENDERERSOLID2LAYER_H_
...
namespace irrgame
{
	namespace video
	{
		...
		class COpenGLMaterialRendererSolid2Layer: public COpenGLMaterialRenderer
		{
			public:

				//! Default constructor
				COpenGLMaterialRendererSolid2Layer(IVideoDriver* driver);

				//! Destructor
				virtual ~COpenGLMaterialRendererSolid2Layer();
...
#endif /* COPENGLMATERIALRENDERERSOLID2LAYER_H_ */
