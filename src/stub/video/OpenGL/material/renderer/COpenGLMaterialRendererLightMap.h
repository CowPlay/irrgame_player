/*
 * COpenGLMaterialRendererLightmap.h
 *
 *  Created on: Oct 30, 2012
 *      Author: gregorytkach
 */

#ifndef COPENGLMATERIALRENDERERLIGHTMAP_H_
#define COPENGLMATERIALRENDERERLIGHTMAP_H_
...
namespace irrgame
{
	namespace video
	{
		...
		class COpenGLMaterialRendererLightMap: public COpenGLMaterialRenderer
		{
			public:

				//! Default constructor
				COpenGLMaterialRendererLightMap(IVideoDriver* driver);

				//! Destructor
				virtual ~COpenGLMaterialRendererLightMap();
...
#endif /* COPENGLMATERIALRENDERERLIGHTMAP_H_ */
