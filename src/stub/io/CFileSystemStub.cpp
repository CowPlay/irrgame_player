...
//		IReadFile* CFileSystemStub::createLimitReadFile(
//				const io::path& fileName, IReadFile* alreadyOpenedFile,
...
//
//		//! Creates an IReadFile interface for treating memory like a file.
//		IWriteFile* CFileSystemStub::createMemoryWriteFile(void* memory,
//				s32 len, const io::path& fileName, bool deleteMemoryWhenDropped)
//		{
//			if (!memory)
//				return 0;
//			else
...
//		IWriteFile* CFileSystemStub::createAndWriteFile(
...
//		bool CFileSystemStub::changeWorkingDirectoryTo(
...
//		}
//
//		io::path CFileSystemStub::getAbsolutePath(
