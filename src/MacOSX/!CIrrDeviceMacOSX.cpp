...
//		storeMouseLocation();
//
//		event = objc_msgSend(CLASS("NSApp"), SELECTOR("nextEventMatchingMask:untilDate:inMode:dequeue:"), (0xffffffffU), SEND_OBJC_MESSAGE(CLASS("NSDate", "distantPast")), nil/*NSDefaultRunLoopMode*/, true);
//		event = [NSApp nextEventMatchingMask:NSAnyEventMask untilDate:[NSDate distantPast] inMode:NSDefaultRunLoopMode dequeue:YES];
//		if (event != nil)
//		{
//			bzero(&ievent,sizeof(ievent));
//
//		switch ((int)SEND_OBJC_MESSAGE(event, "type"))
//		{
//			int modifierFlags = (int)SEND_OBJC_MESSAGE(event, "modifierFlags");
//		}
...
//				}
//
//		SEND_OBJC_MESSAGE_WITH_OBJECT(CLASS("NSApp"), "sendEvent:", event);
...
//		pollJoysticks();
//
//		return (!SEND_OBJC_MESSAGE(SEND_OBJC_MESSAGE(CLASS("NSApp", "delegate")), "isQuit") && IsActive);
//	}
//
