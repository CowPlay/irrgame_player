...
//			}
		...
		IMaterialRenderer* IMaterialRenderer::createMaterialRendererReflection2Layer(IVideoDriver* driver)
		{
			return new COpenGLMaterialRendererReflection2Layer(driver);
		}
