/*
 * COpenGLMaterialRendererSphereMap.h
 *
 *  Created on: Oct 30, 2012
 *      Author: gregorytkach
 */

#ifndef COPENGLMATERIALRENDERERSPHEREMAP_H_
#define COPENGLMATERIALRENDERERSPHEREMAP_H_
...
namespace irrgame
{
	namespace video
	{
		...
		class COpenGLMaterialRendererSphereMap: public COpenGLMaterialRenderer
		{
			public:

				//! Default constructor
				COpenGLMaterialRendererSphereMap(IVideoDriver* driver);

				//! Destructor
				virtual ~COpenGLMaterialRendererSphereMap();
...
#endif /* COPENGLMATERIALRENDERERSPHEREMAP_H_ */
